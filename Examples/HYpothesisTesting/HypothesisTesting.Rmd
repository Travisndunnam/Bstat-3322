...
## Statistical conclusion
Necause the p-value of `r pValue` is much higher than 5% we can't conclude that the bull hypothesis is incorrect.  

## Clinical conclusion 
There is insufficient sample evidence to conclude that Desipramine reduces relabses more than Lithium.