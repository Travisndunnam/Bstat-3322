...
#
# We demonstrate the bootstrapping of the sample standard
# deviation of the average commute time in Atlanta Georgia
# using the data provided at the LOck5 Wed site: 
# 
...
one.boot( CA$Time,    # The variable of interest
          sd,       # The desired statistical function
...
# and slight skewed under these conditions we should     #
